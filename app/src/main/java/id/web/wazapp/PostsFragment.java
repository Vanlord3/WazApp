...
//        fragment.setArguments(args);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ivbAddPost = view.findViewById(R.id.imageButtonAddPost);
        ...
        ivbAddPost.setOnClickListener(view1 -> {
...
//            etJumlah.setText("");
    ...
    private class getPost extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Log.d("Post:",listPosts.toString());
            if(listPosts.size()>0 && listUser.size()>0){
                allPostsAdapter = new AllPostsAdapter(getContext(),listPosts,listUser);
                rvPosts.setAdapter(allPostsAdapter);
            }
            else {
